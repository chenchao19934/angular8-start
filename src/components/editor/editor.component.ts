...
import { forwardRef, Component, ElementRef, EventEmitter, Input, OnInit, AfterViewInit, Output, ViewChild } from '@angular/core';
...
export class EditorComponent implements ControlValueAccessor, OnInit, AfterViewInit {
