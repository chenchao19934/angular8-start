...
import { forwardRef, Component, ElementRef, Input, OnInit, Output, ViewChild, OnChanges } from '@angular/core';
...
export class UploadFileComponent implements ControlValueAccessor, OnInit, OnChanges {
